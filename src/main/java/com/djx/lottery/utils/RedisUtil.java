...
public class RedisUtil {
    ...
    /**
      * @Author: jx.duan
      * @Description: 获取set中随机i个元素 不删除
      * @Date: 2021/3/27 16:29
      * @Param: [key, i]
      * @Return:  java.util.List<java.lang.String>
      */
    public List<String> sGetRand(String key,long i) {
        try {
            return template.opsForSet().randomMembers(key,i);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    /**
      * @Author: jx.duan
      * @Description: 获取set中随机i个元素 删除
      * @Date: 2021/3/27 16:45
      * @Param: [joinUser, i]
      * @Return: java.util.List<java.lang.String>
      */
    public List<String> sGetRandAndDel(String key, long i) {
        try {
            return template.opsForSet().pop(key,i);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
